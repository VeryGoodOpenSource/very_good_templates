# Contributing to Very Good Docs Site (Jaspr)
...
[bug_report_link]: https://github.com/VeryGoodOpenSource/very_good_templates/issues/new?assignees=&labels=bug&template=bug_report.md&title=fix%3A+

...
```sh
# {{flavor_dev}}
$ flutter run --flavor {{flavor_dev}} --target lib/main_{{flavor_dev}}.dart

# {{flavor_staging}}
$ flutter run --flavor {{flavor_staging}} --target lib/main_{{flavor_staging}}.dart

# {{flavor_prod}}
$ flutter run --flavor {{flavor_prod}} --target lib/main_{{flavor_prod}}.dart
```

...
#ifndef __PROJECT_NAME_SNAKECASE_____MACOS_SWIFT_H
#define __PROJECT_NAME_SNAKECASE_____MACOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="__project_name_snakeCase_____macos",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))

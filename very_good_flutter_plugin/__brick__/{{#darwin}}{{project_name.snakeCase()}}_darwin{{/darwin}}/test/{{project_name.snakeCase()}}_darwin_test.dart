...
import 'package:{{project_name.snakeCase()}}_darwin/{{project_name.snakeCase()}}_darwin.dart';
...
void main() {
  ...
  group({{project_name.pascalCase()}}Darwin, () {
    const kPlatformName = 'Darwin';
    late {{project_name.pascalCase()}}Darwin {{project_name.camelCase()}};
    late {{project_name.pascalCase()}}Api api;

    setUp(() {
      api = _Mock{{project_name.pascalCase()}}Api();
      {{project_name.camelCase()}} = {{project_name.pascalCase()}}Darwin(api: api);
    });

    test('can be registered', () {
      {{project_name.pascalCase()}}Darwin.registerWith();
      expect(
        {{project_name.pascalCase()}}Platform.instance,
        isA<{{project_name.pascalCase()}}Darwin>(),
      );
    });
